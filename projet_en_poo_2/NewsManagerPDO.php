...
class NewsManagerPDO extends NewsManager
{
  ...
  public function getList($debut = -1, $limite = -1)
  {
    ...
    // Permet de récupérer toutes les requêtes directement sous forme d'objet (pas de tableau)
    // Grâce au Fetchmode  FETCH_CLASS              LATE permet d'hydrater avant d'afficher ! "Later..."
    $requete->setFetchMode(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, 'News');
    
    // Pas besoin d'une boucle while, on fetchAll()
